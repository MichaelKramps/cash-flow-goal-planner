        ...
        return(
            <div className={Shared.determineVisibility(this.props)}>
                ...
                <RoadMapCheckboxSection checked={this.state.financing} title="Secure financing">
                    ...
                    <p>If you’re looking for an online business I suggest reading <a target="_blank" href="https://www.unboundinvestor.com/complete-list-of-21-marketplaces-to-buy-a-website/">https://www.unboundinvestor.com/complete-list-of-21-marketplaces-to-buy-a-website/</a>, then going to each website and calling the phone numbers. Talk to someone and ask if they can help walk you through the process. Also ask if they know any online business lenders you can work with.</p>
                ...
                <RoadMapCheckboxSection checked={this.state.search} title="Search for a business to buy (optionally find a broker)">
                    ...
                    <p>To find online brokers check out this article <a target="_blank" href="https://www.unboundinvestor.com/complete-list-of-21-marketplaces-to-buy-a-website/">https://www.unboundinvestor.com/complete-list-of-21-marketplaces-to-buy-a-website/</a>.</p>
                </RoadMapCheckboxSection>
